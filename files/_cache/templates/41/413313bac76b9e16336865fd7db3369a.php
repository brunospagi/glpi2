...
class __TwigTemplate_b14afc1a3f16c1300ec2fc8259c87ca5 extends Template
{
    private $source;
    private $macros = [];
...
($context["locks_rand"] ?? null), "condition" => ["interface" => "central"]])], 271, $context, $this->getSourceContext());
    ...
    ";
        // line 285
        echo twig_call_macro($macros["fields"], "macro_dropdownArrayField", ["lock_item_list", "", $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("ObjectLock::getLockableObjects"), __("List of items to lock"), twig_array_merge(        // line 290
...
<div class=\"row ps-4\">
    ...
    ";
        // line 315
        echo twig_call_macro($macros["fields"], "macro_dropdownTimestampField", ["login_remember_time", (($__internal_compile_21 =         // line 317
($context["config"] ?? null)) && is_array($__internal_compile_21) || $__internal_compile_21 instanceof ArrayAccess ? ($__internal_compile_21["login_remember_time"] ?? null) : null), __("Time to allow \"Remember Me\""), twig_array_merge(        // line 319
($context["inline_field_options"] ?? null), ["emptylabel" => __("Disabled"), "min" => 0, "max" => (twig_constant("MONTH_TIMESTAMP") * 2), "step" => twig_constant("DAY_TIMESTAMP"), "toadd" => [twig_constant("HOUR_TIMESTAMP"), (twig_constant("HOUR_TIMESTAMP") * 2), (twig_constant("HOUR_TIMESTAMP") * 6), (twig_constant("HOUR_TIMESTAMP") * 12)], "width" => "auto"])], 315, $context, $this->getSourceContext());
        // line 332
        echo "

    ";
        // line 334
        echo twig_call_macro($macros["fields"], "macro_checkboxField", ["login_remember_default", (($__internal_compile_22 =         // line 336
...
($context["field_options"] ?? null)], 334, $context, $this->getSourceContext());
    ...
    ";
        // line 341
        echo twig_call_macro($macros["fields"], "macro_checkboxField", ["display_login_source", (($__internal_compile_23 =         // line 343
