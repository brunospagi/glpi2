...
class __TwigTemplate_8bf6927898e8cac6ee8a81982ff94087 extends Template
{
    private $source;
    private $macros = [];
...
";
   ...
   ";
            // line 38
            $context["picture_single"] = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "getItemtypeOrModelPicture", ["picture"], "method", false, false, false, 38);
            // line 39
            echo "   ";
            $context["picture_front"] = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "getItemtypeOrModelPicture", ["picture_front"], "method", false, false, false, 39);
            // line 40
            echo "   ";
            $context["picture_rear"] = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "getItemtypeOrModelPicture", ["picture_rear"], "method", false, false, false, 40);
            // line 41
            echo "   ";
            $context["pictures_misc"] = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "getItemtypeOrModelPicture", ["pictures"], "method", false, false, false, 41);
            // line 42
            echo "
   ";
            // line 43
            ...
            <div class=\"d-flex\">
               ";
                ...
                if ( !twig_test_empty(($context["picture_single"] ?? null))) {
                    ...
                    // line 53
                    echo "                  ";
                    $context["imgs"] = [twig_array_merge(($context["picture_single"] ?? null), ["title" => _n("Picture", "Pictures", 1)])];
                    // line 54
                    echo "               ";
                } else {
                    // line 55
                    ...
                    if ((( !twig_test_empty(($context["picture_front"] ?? null)) ||  !twig_test_empty(($context["picture_rear"] ?? null))) ||  !twig_test_empty(($context["pictures_misc"] ?? null)))) {
                        ...
                        if ((twig_length_filter($this->env, ($context["picture_front"] ?? null)) >= 1)) {
                            ...
                            // line 59
                            echo "                        ";
                            $context["imgs"] = twig_array_merge(($context["imgs"] ?? null), [twig_array_merge(($context["picture_front"] ?? null), ["title" => __("Front picture")])]);
                            // line 60
                            echo "                     ";
                        }
                        // line 61
                        ...
                        if ((twig_length_filter($this->env, ($context["picture_rear"] ?? null)) >= 1)) {
                            ...
                            // line 63
                            echo "                        ";
                            $context["imgs"] = twig_array_merge(($context["imgs"] ?? null), [twig_array_merge(($context["picture_rear"] ?? null), ["title" => __("Rear picture")])]);
                            // line 64
                            echo "                     ";
                        }
                        // line 65
   ...
   ";
    ...
    {
        return new Source("", "components/form/pictures.html.twig", "/home/storage/6/a2/53/sept-glpiservico1/public_html/templates/components/form/pictures.html.twig");
    }
}
