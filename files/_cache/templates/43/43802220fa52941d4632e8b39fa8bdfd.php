...
class __TwigTemplate_53cf2a6ae7b0578367b9b79fa4ea292e extends Template
{
    private $source;
    private $macros = [];
...
($context["flags_html"] ?? null), _n("Port", "Ports", Session::getPluralNumber())], 45, $context, $this->getSourceContext());
    ...
    {
        return new Source("", "pages/assets/monitor.html.twig", "/home/storage/6/a2/53/sept-glpiservico1/public_html/templates/pages/assets/monitor.html.twig");
    }
}
